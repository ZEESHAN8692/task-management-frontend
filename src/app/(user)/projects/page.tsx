      ...
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-[#F1F5F9] mb-8">Projects</h1>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#1B263B] rounded-lg p-6 border-2 border-dashed border-[#415A77]/40 hover:border-[#415A77]/60 transition-colors cursor-pointer flex items-center justify-center">
