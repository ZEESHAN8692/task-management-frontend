                ...
                <div className="max-w-7xl mx-auto px-6 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <p className="text-sm mb-4">Modern task management with Kanban boards</p>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li><a href="#api" className="hover:text-blue-400 transition-colors">API Docs</a></li>
                    ...
                    <div className="border-t border-slate-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
                        ...
                        <div className="flex space-x-6 mt-4 md:mt-0">
                            ...
                            <a href="#api" className="hover:text-blue-400 transition-colors">API Docs</a>
                        </div>
                    </div>
                </div>
            </footer>
