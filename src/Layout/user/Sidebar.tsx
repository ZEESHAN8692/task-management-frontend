...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onToggle }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 z-50 h-screen w-64 bg-[#0D1B2A] border-r border-[#415A77]/20 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:z-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
